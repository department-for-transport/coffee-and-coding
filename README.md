...
| :-------------- | :---- | :------ | :----------------------------------------------------------- | :-------------------------------------------- | :----------------------------------------------------------- |
| Wed 17 Apr 2019 | 11:00 | H2      | BBplot and Python graphics          | Edwin Lowther          | Edwin Lowther, BBC journalist, will cover how the BBC creates graphics with its custom R package [bbplot](https://github.com/bbc/bbplot), as well as graphics in Python. |
| Thu 11 Apr 2019 | 11:00 | H3      | R training - Show and tell          | Isi Avbulimen                     | This session is for us to reflect and celebrate the progress that people have made in learning R within DfT, so come along with a story or product that you have made with R and share with colleagues, including those who have completed the various R training cohorts over the past 6 months. |
| Wed 03 Apr 2019 | 11:00 | H2      | BQ with Pythin & R  | Kim Brett & Tamsin Forbes | Using Python and R to execute SQL in Google Cloud Platform's BigQuery |
